import ProductDetailsTabSync from "@/components/ProductDetailsTabSync";
              ...
              <div className="container">
                <div className="row d-flex justify-content-center text-center">
                  <div className="col-lg-8">
                    <h1 className="heading-title">Product Details</h1>
                    <p className="mb-0">
                      See how this product supports members with coverage guidance, coordinated care access, and everyday plan management.
                    </p>
                  </div>
                </div>
              </div>
